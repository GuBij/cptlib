...
The main file demonstrates these use cases. For instance, using this library a graph as below can be created in a few commands: given a probe, it displays the soil behavior types, the measured cone resistance (qc) and the friction ratio (Rf).
